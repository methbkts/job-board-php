...
* Frontend : React (principal), Vue.js (projet à migrer), TypeScript. HTML/CSS avec Tailwind CSS.
* Backend : PHP8, Symfony6, API Platform, ElasticSearch, Redis, Aurora
* API & communication : REST.
* CI/CD : GitHub Actions / Circle CI ou équivalent.
* Tests : Jest, Playwright/Cypress (ou équivalent).
* Outils DevOps : Docker, intégration dans des pipelines CI/CD, AWS, Python.

Sezane recherche aujourd’hui des talents créatifs, structurés et agiles qui partagent l’envie d’améliorer sans cesse tout ce qui peut l’être. Des talents passionnés, autonomes qui conçoivent le travail dans le respect des autres et pour qui rien n'est hors d'atteinte, pour peu qu'on s'en donne les moyens.

# Développeur(se) backend sénior PHP / Symfony
...
* Concevoir, développer et maintenir des interfaces front-end modernes en React
* Participer aux intégrations HTML/CSS et utiliser Tailwind pour garder un haut niveau de qualité visuelle
* Garantir la qualité du code via des bonnes pratiques (tests unitaires, end-to-end, CI/CD)
* Améliorer la stratégie de tests automatisés et la fiabilité des déploiements 
* Optimiser les performances et assurer la sécurité des applications
* Collaborer efficacement avec l’équipe back-end PHP et les prestataires externes
* Participer aux choix d’architectures et proposer des évolutions techniques pertinentes
* Contribuer à la revue de code et aux discussions internes à la team front
* Porter une dynamique positive au sein de l’équipe, en prenant des initiatives et en impulsant une culture de qualité

## Profil : 

* 6 ans d’expérience minimum en développement JavaScript/TypeScript
* Excellente maîtrise de React, connaissance de Vue.js (expérience migration = un plus) 
* Confort avec l’intégration HTML/CSS et Tailwind CSS 
* Solide expérience en tests automatisés, CI/CD et bonnes pratiques de qualité logicielle 
* Expertise en optimisation des performances et en sécurité front-end 
* Autonomie, esprit d’initiative, excellente communication 
* Capacité à insuffler de l’énergie dans l’équipe et à jouer un rôle moteur 
